...
/* ----------------------------------------------------------------------------------
	Services - Specific for Consulting theme
---------------------------------------------------------------------------------- */
...
class thinkup_builder_services extends WP_Widget {
	...
	function form($instance) {
		...
		echo '<p><label for="' . $this->get_field_id('color') . '" style="display: inline-block;width: 150px;">Color Scheme:</label>
			<select name="' . $this->get_field_name('color') . '" id="' . $this->get_field_id('color') . '" style="display: inline-block;width: 200px;margin: 0;">
			<option '; ?><?php if($color == "light") { echo "selected"; } ?><?php echo ' value="light">Light</option>
			<option '; ?><?php if($color == "dark") { echo "selected"; } ?><?php echo ' value="dark">Dark</option>
			</select>
		</p>';
	...
	function widget($args, $instance) {
		...
		if ( empty( $style ) or $style == 'style1' ) {
			...
			echo '[services1 icon="' . $icon . '" color="' . $color . '" heading="' . $heading . '" link="' . $link . '" link_text="' . $link_text . '" animate="' . $animate . '" delay="' . $delay . '"]' . $text . '[/services1]';

		} else if ( $style == 'style2' ) {

			echo '[services2 icon="' . $icon . '" color="' . $color . '" heading="' . $heading . '" link="' . $link . '" link_text="' . $link_text . '" animate="' . $animate . '" delay="' . $delay . '"]' . $text . '[/services2]';
