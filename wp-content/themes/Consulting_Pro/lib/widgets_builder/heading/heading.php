...
class thinkup_builder_headingtheme extends WP_Widget {
	...
	function form($instance) {
		...
		$heading_lineheight = $instance['heading_lineheight'];
		...
		echo '<p><label for="' . $this->get_field_id('heading_lineheight') . '" style="display: inline-block;width: 150px;" >Line Height (px):</label>
			<select name="' . $this->get_field_name('heading_lineheight') . '" id="' . $this->get_field_id('heading_lineheight') . '" style="display: inline-block;width: 200px;margin: 0;" >';
			echo '<option '; ?><?php if($heading_lineheight == "0") { echo "selected"; } ?><?php echo ' value="0">Default</option>';
			foreach ( range(10,80) as $k ) {
				echo '<option '; ?><?php if( $heading_lineheight == $k ) { echo "selected"; } ?><?php echo ' value="' . $k . '">' . $k . '</option>';
			}
		echo '</select>',
			 '</p>';
	...
	function update($new_instance, $old_instance) {
		...
		$instance['heading_lineheight'] = $new_instance['heading_lineheight'];
	...
	function widget($args, $instance) {
		...
		if ( ! empty( $heading_text ) ) {
			...
			if ( $heading_size !== '0' or $heading_lineheight !== '0' or $heading_weight !== '0' or $heading_style !== '0' ) {
				...
				if ( $heading_lineheight !== '0' ) {
					$output .= 'line-height: ' . $heading_lineheight . 'px;';
				}
...
add_action( 'widgets_init', function() { return register_widget( "thinkup_builder_headingtheme" ); } );
