...
<div class="rslides-inner">
	...
	<?php $image  = $context['image']; ?>
		<li>
	<img src="<?php echo esc_url( get_template_directory_uri() ) . '/images/transparent.png'; ?>" style="background: url(<?php echo $image; ?>) no-repeat center; background-size: cover;" alt="Demo Image" />
	</li>
	<?php } ?>
	</ul>
</div>
