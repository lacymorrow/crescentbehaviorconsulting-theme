...
global $thinkup_homepage_sliderpreset;
	...
	foreach ($thinkup_homepage_sliderpreset as $slide) {
		...
		echo '<li>',
			 ...
			 '<div class="featured"><div class="featured-wrap">';
...
global $wp_embed;
	...
	$output_video = NULL;
		...
		$output_text .= '<div class="featured' . $thinkup_classtext . '"><div class="featured-wrap">';
...
if ( ! empty( $post->ID ) ) {
	...
	foreach ( $_thinkup_meta_sliderpage['image'] as $slide => $list) {
		...
		echo '<li>',
			...
			// Input slider icon with slider style3 class - Consulting specific!
...
global $thinkup_homepage_section3_button;
	...
	if ( empty( $thinkup_homepage_section1_button ) )
		$thinkup_homepage_section1_button = __( 'Read More', 'consulting' );
	if ( empty( $thinkup_homepage_section2_button ) )
		$thinkup_homepage_section2_button = __( 'Read More', 'consulting' );
	if ( empty( $thinkup_homepage_section3_button ) )
		$thinkup_homepage_section3_button = __( 'Read More', 'consulting' );
	...
	if ( is_front_page() ) {
		...
		echo '<div id="section-home"><div id="section-home-inner">';
			...
			echo	'</div>',
					'<div class="iconmain">',
					'<h3>' . $thinkup_homepage_section1_title . '</h3>' . wpautop( esc_html( do_shortcode ( $thinkup_homepage_section1_desc ) ) );
					if ( ! empty( $thinkup_homepage_section1_link ) ) {
						echo '<p class="iconurl"><a class="themebutton2" href="' . esc_url( $thinkup_homepage_section1_link ) . '"' . $thinkup_homepage_section1_target . '>' . esc_html( $thinkup_homepage_section1_button ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
			...
			echo	'</div>',
					'<div class="iconmain">',
					'<h3>' . $thinkup_homepage_section2_title . '</h3>' . wpautop( esc_html( do_shortcode ( $thinkup_homepage_section2_desc ) ) );
					if ( ! empty( $thinkup_homepage_section2_link ) ) {
						echo '<p class="iconurl"><a class="themebutton2" href="' . esc_url( $thinkup_homepage_section2_link ) . '"' . $thinkup_homepage_section2_target . '>' . esc_html( $thinkup_homepage_section2_button ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
			...
			echo	'</div>',
					'<div class="iconmain">',
					'<h3>' . $thinkup_homepage_section3_title . '</h3>' . wpautop( esc_html( do_shortcode ( $thinkup_homepage_section3_desc ) ) );
					if ( ! empty( $thinkup_homepage_section3_link ) ) {
						echo '<p class="iconurl"><a class="themebutton2" href="' . esc_url( $thinkup_homepage_section3_link ) . '"' . $thinkup_homepage_section3_target . '>' . esc_html( $thinkup_homepage_section3_button ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
	...
	if ( $thinkup_homepage_outroswitch == '1' and is_front_page() and ! empty( $thinkup_homepage_outroaction ) ) {
		...
		echo '<div id="outroaction"><div id="outroaction-core">';
			...
			if ( ( !empty( $thinkup_homepage_outroactionlink1) and $thinkup_homepage_outroactionlink1 !== 'option3' ) ) {
				...
				// Set default value of buttons to "Read more"
				if( empty( $thinkup_homepage_outroactiontext1 ) ) { $thinkup_homepage_outroactiontext1 = __( 'Read More', 'consulting' ); }
		...
		echo '<div id="outroaction"><div id="outroaction-core">';
			...
			if ( ( !empty( $thinkup_footer_outroactionlink1) and $thinkup_footer_outroactionlink1 !== 'option3' ) ) {
				...
				// Set default value of buttons to "Read more"
				if( empty( $thinkup_footer_outroactiontext1 ) ) { $thinkup_footer_outroactiontext1 = __( 'Read More', 'consulting' ); }
