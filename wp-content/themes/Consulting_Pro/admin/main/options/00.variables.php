...
function thinkup_reduxvariables() { 
	...
	$GLOBALS['thinkup_general_introstyle']                  = thinkup_var ( 'thinkup_general_introstyle' );
	$GLOBALS['thinkup_general_introbackgroundcolor']        = thinkup_var ( 'thinkup_general_introbackgroundcolor' );
	$GLOBALS['thinkup_general_introbackgroundimage']        = thinkup_var ( 'thinkup_general_introbackgroundimage', 'url' );
	...
	$GLOBALS['thinkup_header_float']                        = thinkup_var ( 'thinkup_header_float' );
	$GLOBALS['thinkup_header_logooverflow']                 = thinkup_var ( 'thinkup_header_logooverflow' );
