...
// START - WooCommerce API Manager Integration - v2.x

// Set API server url
$api_url = 'http://www.thinkupthemes.com';

if ( ! class_exists( 'WC_AM_Client' ) ) {

    // Uncomment next line if this is a theme
//	require_once( get_template_directory() . '/lib/update-api/wc-am-client.php' );
}
...
if ( class_exists( 'WC_AM_Client' ) ) {
	...
	$wcam_lib = new WC_AM_Client( __FILE__, 'Consulting Pro', $thinkup_theme_version, 'theme', $api_url, 'Consulting Pro' );
}
// END - WooCommerce API Manager Integration - v2.x
...
//----------------------------------------------------------------------------------
	...
	if ( extension_loaded( 'simplexml' ) ) {
		...
		// Add Upgrade Notice
		if( file_exists( get_template_directory() . '/lib/update/update_notice_consulting.php' ) )
			require_once( get_template_directory() . '/lib/update/update_notice_consulting.php' );
...
function thinkup_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Sub-Footer Column 1', 'consulting' ),
        'id'            => 'sub-footer-w1',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
    ...
    register_sidebar( array(
        'name'          => __( 'Sub-Footer Column 2', 'consulting' ),
        'id'            => 'sub-footer-w2',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="sub-footer-widget-title"><span>',
